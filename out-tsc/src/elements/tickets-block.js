...
class TicketsBlock extends ReduxMixin(PolymerElement) {
    constructor() {
        super(...arguments);
        this.tickets = [];
        this.ticketsFetching = false;
        this.ticketsFetchingError = {};
        this.viewport = {};
        this.contentLoaderVisibility = false;
    }
    static get template() {
        return html `
    ...
    connectedCallback() {
        ...
        window.HOVERBOARD.Elements.Tickets = this;
    }
...
//# sourceMappingURL=tickets-block.js.map