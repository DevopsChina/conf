...
class PolymerHelmet extends PolymerElement {
    constructor() {
        ...
        this._defaultImage = '{$ image if image.startsWith("http") else (url + image) $}';
        this._defaultDescription = '{$ description $}';
        this._defaultLabel1 = '{$ location.label $}';
        this._defaultData1 = '{$ location.name $}';
        this._defaultLabel2 = '';
        this._defaultData2 = '';
    }
    static get template() {
...
//# sourceMappingURL=polymer-helmet.js.map