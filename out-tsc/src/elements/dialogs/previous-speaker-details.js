...
class PreviousSpeakerDetails extends ReduxMixin(mixinBehaviors([IronOverlayBehavior], PolymerElement)) {
    static get template() {
        return html `
    ...
    _getSessions(sessions) {
        return (sessions &&
            Object.keys(sessions)
                ...
                return aggregator.concat(sessions[year].map((session) => Object.assign({}, session, { year })));
            }, [])
...
//# sourceMappingURL=previous-speaker-details.js.map