...
describe('hero-block', () => {
    ...
    it('has default values', async () => {
        const { element, shadowRoot } = await fixture(html `<hero-block></hero-block>`);
        ...
        expect(shadowRoot.querySelector('.hero-overlay')).not.toHaveAttribute('show');
        expect(shadowRoot.querySelector('.hero-image')).toBeNull();
    });
    it('accepts values', async () => {
        const { element, shadowRoot } = await fixture(html `
        <hero-block
          active
      ...
      `);
        ...
        expect(shadowRoot.querySelector('.hero-overlay')).toHaveAttribute('show');
        expect(shadowRoot.querySelector('.hero-image')).not.toBeNull();
    });
    ...
    it('renders an image', async () => {
        const { shadowRoot } = await fixture(html `<hero-block background-image="/example.jpg"></hero-block>`);
    ...
    describe('setHeroSettings', () => {
        it('notifies when active', async () => {
            await fixture(html `<hero-block active background-image="/example.jpg"></hero-block>`);
        ...
        it('does not notify when inactive', async () => {
            await fixture(html `<hero-block background-image="/example.jpg"></hero-block>`);
            expect(setHeroSettings).not.toHaveBeenCalled();
        });
    });
});
//# sourceMappingURL=hero-block.test.js.map