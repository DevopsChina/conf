    ...
    getToken: (subscribe = false) => (dispatch, getState) => {
        ...
        return messaging
            ...
            if (currentToken) {
                ...
                Promise.all([subscribersPromise, userSubscriptionsPromise]).then(([subscribersSnapshot, userSubscriptionsSnapshot]) => {
                    ...
                    const userSubscriptions = userSubscriptionsSnapshot && userSubscriptionsSnapshot.exists
                        ...
                        : {};
                    const isUserSubscribed = !!(userSubscriptions.tokens && userSubscriptions.tokens[currentToken]);
