...
import { setFastDomIf, setLegacyWarnings, setPassiveTouchGestures, setRemoveNestedTemplates, setSuppressTemplateNotifications, } from '@polymer/polymer/lib/utils/settings';
...
import { notificationsActions, routingActions, ticketsActions, toastActions, uiActions, userActions, } from './redux/actions';
...
class HoverboardApp extends ReduxMixin(PolymerElement) {
    constructor() {
        ...
        this.user = {};
        this.providerUrls = '{$ signInProviders.allowedProvidersUrl $}'.split(',');
        this.tickets = { list: [] };
        this.isPhoneSize = false;
        this.isLaptopSize = false;
        this.appRoute = {};
        this.subRoute = {};
        this.routeData = {};
...
//# sourceMappingURL=hoverboard-app.js.map