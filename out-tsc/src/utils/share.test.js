...
describe('share', () => {
    let open;
    const features = (height) => `menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=600,height=${height}`;
    const twitterUrl = [
        'https://twitter.com/intent/tweet?',
        'text=Check%20out%20Awesome%20Schedule%20at%20%23%7B%24%20hashtag%20%24%7D%3A%20http%3A%2F%2Flocalhost%2F',
    ].join('');
    beforeAll(() => {
        window.href = 'https://example.com/schedule';
    ...
    it('shares to Facebook', () => {
        ...
        expect(window.open).toHaveBeenCalledWith('https://www.facebook.com/sharer.php?u=http%3A%2F%2Flocalhost%2F&t=Awesome%20Schedule', 'share', features(775));
    });
