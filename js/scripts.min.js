(function(a){a(document).ready(function(){a(window).load(function(){a("#st-container").removeClass("disable-scrolling");a("#loading-animation").fadeOut();a("#preloader").delay(350).fadeOut(800);var b=document.createElement("script");b.type="text/javascript";b.async=!0;b.src="https://cdn.bootcss.com/platform/1.3.5/platform.js";var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(b,d);equalheight(".same-height")});1500<a(window).width()&&a(".effect-wrapper").addClass("col-lg-3");768>a(window).width()&&
